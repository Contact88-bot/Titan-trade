...
const Dashboardx = () => {
  ...
  // useEffect(() => {
  //   fetch("https://wide-eyed-cyan-angler.cyclic.app/get-profile", {
  //     method: "post",
    ...
    <div>
      ...
      <div className="px-0 lg:px-0 w-full">
        <div className="md:flex relative">
          {/* left Section */}
          <section
            className="hidden md:relative z-10 top-0 left-0 bottom-0 w-full bg-white max-h-full md:flex md:flex-col md:items-center md:w-4/12 lg:w-1/5 bg-red-5 shadow-lg"
            style={{
          ...
          <div className="flex-1 bg-[#f5f6fa] h-screen">
            ...
            <section className="lg:bg-gray-50 h-screen">
              <div class="px-6 pt-6">
              ...
              <div className="md:flex justify-between md:mt-12">
                <div class="py-6 px-3 shadow-lg my-5 mx-5 border border-gray-300 border-b-4 border-b-red-400 md:w-1/3">
                  ...
                  <p class="flex justify-between items-center font-semibold pt-16 md:inline">
                    <Link
                      class="flex items-center pl-4 pr-2 py-1.5  w-fit text-sm bg-red-500 text-white rounded-md md:my-3"
                      to="/user/deposit"
                    >
                      <span>Deposit</span>
                      <svg
